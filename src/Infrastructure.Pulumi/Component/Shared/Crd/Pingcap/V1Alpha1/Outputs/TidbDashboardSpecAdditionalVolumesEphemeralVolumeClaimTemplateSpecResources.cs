...
namespace Pulumi.Kubernetes.Types.Outputs.Pingcap.V1Alpha1
{
    ...
    [OutputType]
    public sealed class TidbDashboardSpecAdditionalVolumesEphemeralVolumeClaimTemplateSpecResources
    {
        ...
        [OutputConstructor]
        private TidbDashboardSpecAdditionalVolumesEphemeralVolumeClaimTemplateSpecResources(
