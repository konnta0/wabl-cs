...
namespace Pulumi.Kubernetes.Types.Inputs.Pingcap.V1Alpha1
{
    ...
    public class TidbDashboardSpecAdditionalVolumesIscsiArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Pingcap.V1Alpha1.TidbDashboardSpecAdditionalVolumesIscsiSecretRefArgs>? SecretRef { get; set; }

        [Input("targetPortal", required: true)]
        public Input<string> TargetPortal { get; set; } = null!;

        public TidbDashboardSpecAdditionalVolumesIscsiArgs()
        {
        }
        public static new TidbDashboardSpecAdditionalVolumesIscsiArgs Empty => new TidbDashboardSpecAdditionalVolumesIscsiArgs();
    }
}
