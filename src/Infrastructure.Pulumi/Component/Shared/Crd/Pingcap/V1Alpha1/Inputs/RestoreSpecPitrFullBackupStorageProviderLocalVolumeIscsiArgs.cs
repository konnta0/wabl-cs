...
namespace Pulumi.Kubernetes.Types.Inputs.Pingcap.V1Alpha1
{
    ...
    public class RestoreSpecPitrFullBackupStorageProviderLocalVolumeIscsiArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Pingcap.V1Alpha1.RestoreSpecPitrFullBackupStorageProviderLocalVolumeIscsiSecretRefArgs>? SecretRef { get; set; }

        [Input("targetPortal", required: true)]
        public Input<string> TargetPortal { get; set; } = null!;

        public RestoreSpecPitrFullBackupStorageProviderLocalVolumeIscsiArgs()
        {
        }
        public static new RestoreSpecPitrFullBackupStorageProviderLocalVolumeIscsiArgs Empty => new RestoreSpecPitrFullBackupStorageProviderLocalVolumeIscsiArgs();
    }
}
