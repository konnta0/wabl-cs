...
namespace Pulumi.Kubernetes.Types.Inputs.Pingcap.V1Alpha1
{
    ...
    public class TidbClusterSpecTiproxyAdditionalVolumesIscsiArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Pingcap.V1Alpha1.TidbClusterSpecTiproxyAdditionalVolumesIscsiSecretRefArgs>? SecretRef { get; set; }

        [Input("targetPortal", required: true)]
        public Input<string> TargetPortal { get; set; } = null!;

        public TidbClusterSpecTiproxyAdditionalVolumesIscsiArgs()
        {
        }
        public static new TidbClusterSpecTiproxyAdditionalVolumesIscsiArgs Empty => new TidbClusterSpecTiproxyAdditionalVolumesIscsiArgs();
    }
}
