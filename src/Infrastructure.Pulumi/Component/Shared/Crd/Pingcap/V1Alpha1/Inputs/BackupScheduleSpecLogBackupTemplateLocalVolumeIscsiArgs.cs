...
namespace Pulumi.Kubernetes.Types.Inputs.Pingcap.V1Alpha1
{
    ...
    public class BackupScheduleSpecLogBackupTemplateLocalVolumeIscsiArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Pingcap.V1Alpha1.BackupScheduleSpecLogBackupTemplateLocalVolumeIscsiSecretRefArgs>? SecretRef { get; set; }

        [Input("targetPortal", required: true)]
        public Input<string> TargetPortal { get; set; } = null!;

        public BackupScheduleSpecLogBackupTemplateLocalVolumeIscsiArgs()
        {
        }
        public static new BackupScheduleSpecLogBackupTemplateLocalVolumeIscsiArgs Empty => new BackupScheduleSpecLogBackupTemplateLocalVolumeIscsiArgs();
    }
}
