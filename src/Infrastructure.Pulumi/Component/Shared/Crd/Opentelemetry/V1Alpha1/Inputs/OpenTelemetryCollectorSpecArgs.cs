...
namespace Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1
{
    ...
    public class OpenTelemetryCollectorSpecArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("affinity")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1.OpenTelemetryCollectorSpecAffinityArgs>? Affinity { get; set; }
        ...
        /// </summary>
        [Input("ingress")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1.OpenTelemetryCollectorSpecIngressArgs>? Ingress { get; set; }
