...
namespace Infrastructure.Stack
{
    public class DevelopmentStack : Pulumi.Stack
    {
        ...
        public DevelopmentStack(ILogger<DevelopmentStack> logger, Config config, CICDComponent cicdComponent, ContainerRegistry.ContainerRegistryComponent containerRegistryComponent)
        {
            _logger = logger;
