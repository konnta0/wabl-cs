...
namespace Pulumi.Kubernetes.Types.Outputs.Opentelemetry.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class OpenTelemetryCollectorSpecVolumeclaimtemplatesStatusConditions
    {
        /// <summary>
        ...
        [OutputConstructor]
        private OpenTelemetryCollectorSpecVolumeclaimtemplatesStatusConditions(
