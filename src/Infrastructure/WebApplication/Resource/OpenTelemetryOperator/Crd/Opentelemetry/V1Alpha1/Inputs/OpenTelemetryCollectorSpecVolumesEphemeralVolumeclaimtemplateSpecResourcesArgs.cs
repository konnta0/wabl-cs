...
namespace Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1
{
    ...
    /// </summary>
    public class OpenTelemetryCollectorSpecVolumesEphemeralVolumeclaimtemplateSpecResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public OpenTelemetryCollectorSpecVolumesEphemeralVolumeclaimtemplateSpecResourcesArgs()
        {
        }
    }
}
