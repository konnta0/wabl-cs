...
namespace Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1
{
    ...
    /// </summary>
    public class OpenTelemetryCollectorSpecVolumesEphemeralVolumeclaimtemplateMetadataArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public OpenTelemetryCollectorSpecVolumesEphemeralVolumeclaimtemplateMetadataArgs()
        {
        }
    }
}
