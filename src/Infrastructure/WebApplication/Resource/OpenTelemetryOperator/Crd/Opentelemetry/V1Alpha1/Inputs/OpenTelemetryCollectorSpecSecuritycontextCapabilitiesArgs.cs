...
namespace Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1
{
    ...
    /// </summary>
    public class OpenTelemetryCollectorSpecSecuritycontextCapabilitiesArgs : Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public OpenTelemetryCollectorSpecSecuritycontextCapabilitiesArgs()
        {
        }
    }
}
