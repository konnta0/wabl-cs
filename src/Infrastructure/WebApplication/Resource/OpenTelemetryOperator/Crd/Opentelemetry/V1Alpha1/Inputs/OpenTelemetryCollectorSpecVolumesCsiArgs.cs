...
namespace Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1
{
    ...
    /// </summary>
    public class OpenTelemetryCollectorSpecVolumesCsiArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1.OpenTelemetryCollectorSpecVolumesCsiNodepublishsecretrefArgs>? NodePublishSecretRef { get; set; }
        ...
        public OpenTelemetryCollectorSpecVolumesCsiArgs()
        {
        }
    }
}
