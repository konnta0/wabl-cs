...
namespace Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1
{
    ...
    /// </summary>
    public class OpenTelemetryCollectorSpecVolumeclaimtemplatesMetadataArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public OpenTelemetryCollectorSpecVolumeclaimtemplatesMetadataArgs()
        {
        }
    }
}
