...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1
{
    ...
    public class ClusterIssuerSpecAcmeSolversDns01Route53Args : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1.ClusterIssuerSpecAcmeSolversDns01Route53SecretaccesskeysecretrefArgs>? SecretAccessKeySecretRef { get; set; }
