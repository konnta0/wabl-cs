...
namespace Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1
{
    ...
    /// </summary>
    public class OpenTelemetryCollectorSpecVolumesIscsiArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1.OpenTelemetryCollectorSpecVolumesIscsiSecretrefArgs>? SecretRef { get; set; }
        ...
        public OpenTelemetryCollectorSpecVolumesIscsiArgs()
        {
        }
    }
}
