...
namespace Pulumi.Kubernetes.Types.Inputs.Opentelemetry.V1Alpha1
{
    ...
    /// </summary>
    public class OpenTelemetryCollectorSpecVolumeclaimtemplatesSpecResourcesArgs : Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public OpenTelemetryCollectorSpecVolumeclaimtemplatesSpecResourcesArgs()
        {
        }
    }
}
