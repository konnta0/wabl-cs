...
public sealed class KeycloakComponent : IComponent<KeycloakComponentInput, KeycloakComponentOutput>
{
    ...
    {
        var deployment = new Pulumi.Kubernetes.Apps.V1.Deployment("keycloak-deployment", new DeploymentArgs
        {
        ...
        var ingress = new Pulumi.Kubernetes.Networking.V1.Ingress("keycloak-ingress",
            new IngressArgs
            {
