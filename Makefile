...
migration-add:
	...
	docker run -it -v $(ROOT_DIR)src/Tool/DatabseMigration:/src/Tool/DatabseMigration --name=database_migration --rm database_migration dotnet ef migrations add $(NAME)
